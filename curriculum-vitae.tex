...
%            \divider
		...
		{\textalignment
            \begin{quote}
            	Engineer and Physics PhD Graduate, with a strong programming background, seeking a career opportunity to passionately contribute to long-term scientific research.
            \end{quote}
        \vspace{0.5em}
        % ----- ABOUT ME -----
		
		I am a skilled engineer and scientist with a diverse background across a variety of programming systems, 
		including software experience in python scripting and packages, web develeopement (Django), and comprehensive data analysis.
		As an electrical engineer, I also boast hardware programming experience in control systems, FPGAs, digital and analogue 
		electronics, and many other technologies such as CAD and Blender.
		I am a fast learner of new technology, highly-adapable team-member and excellent communicator due to my broad background 
		and teaching experience. I have recently completed a PhD in experimental physics, and am looking for a role in a scientific 
		organisation where my engineering excellence and specialised experience can shine.
		I find the automation of scientific facilities intruiging, all the way from control and data-acquisition, to 
		automated processing-analysis and end-user visulisation.
...
%            \cvreference
			...
			\cvachievementnoicon{Experimental Physics Thesis: Dirac Fermions at Interfaces}{	
				...
				Experience in using programmable scientific equipement and analysis tools, such as at the ANSTO Lucas Heights facility
				to perform neutron/Xray reflectometry. This work encompassed the entire research cycle, from device fab,
				through experimental measurement and analysis, to publishing and communications.
				}
			}
...
% %			\vspace{-2em}
	...
	\cvsection{Professional Experience}
		...
		Performed independent measurements, and been a contributor to multiple beamtimes in 2022/2023. 
		\newline I have developed expertise in using the python package Refnx to analyse Platypus beamtime data and X-ray data,
		 and have worked under the guidance of Dr. David Cortie.
		...
		\cvevent{\normalsize Material Physics - Fuhrer Lab Group}{\normalsize Monash University 
		...
		\textalignment{
		Electronic device fabrication and characteristaion, including OHS and standard operating procedure responsibilities. 
		I streamlining data acquisition and control systems for electronic measurements, with significant experience in GPIB control
		instrumentation for electronic equipment in conjunction with LabView. I have developed a number of software tools for data analysis,
		including a Python package for electrical transport analysis (``pylectric transport''), a Python package for X-ray diffraction analysis
		and Blender scripting.
		I have familiarised myself with software engineering concepts and best-practise, including version-control, typing, 
		object-orientation, unit-testing, and documentation styles.
		...
		Implemented a 300 kHz - 3 MHz digital IQ demodulator circuit on an FPGA using HDL to perform opto-electronic magnetometry
		as a collaborative final year project with Lincoln Turner (Physics) and James Saunderson (Engineering).

		\divider

		\cveventlong{\normalsize Real time system design project}{\normalsize ECE5881, Monash}{Mar 2017 -- Jun 2017}{Clayton, Australia}

		Implemented a C++ hardware PID control loop using HDL and a RISC architecture processor. The embedded task was to synchronise needle
		motion to a free-swinging pendulum, using a light-beam hardware interrupt as the signal source.
		...
		This system was implemented in C++ using a programmable system-on-chip.

		\divider

		\cveventlong{\normalsize Summer Internship}{\normalsize Monash bioinformatics platform}{Dec 2012 -- Feb 2013}{Clayton, Australia}
		Contributed to UI-web elements of the `myTardis' Synchrotron stack, a django application for researcher data.

		\divider

		\cveventlong{\normalsize Research User}{\normalsize Melbourne Centre for Nanofabrication}{Jun 2018 -- Present}{Clayton, Australia}
		Experience in programming and optimising facility equipment for the electronic device fabrication, 
		including responsible after-hours use and establishing new processes. I designed and programmatically
		generated 2D mask patterning for variety of materials science problems, using python and the API of KLayout.
		I also utilised Linux OS equipment.
		}
