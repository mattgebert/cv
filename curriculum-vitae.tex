...
%            \divider
        ...
        \cvsection{About Me}
            \begin{quote}
            	Software savvy  electrical \& computer system engineer and condensed matter physicist, seeking opportunities to passionately contribute to long-term scientific research and education.
            \end{quote}
        \vspace{0.5em}
		{\textalignment
        % ----- ABOUT ME -----
		I am a skilled physicist and engineer, with a diverse background in scientific python, beamline science, nanofabrication and UHV systems,digital and analogue electronics, and many other technologies. I am a fast learner of new technology, and a highly-adaptable team-member, and excellent trainer/teacher. 
		As a postdoctoral fellow in synchrotron science, my work has been strongly focused around pythonic software development for beamline science. I am looking for a role in a scientific context where my engineering excellence and specialised experience can shine.
...
%            \cvreference
			...
			\cvachievementnoicon{Experimental Physics Thesis: Dirac Fermions at Interfaces}{	
				Investigated the properties of Dirac materials when put into proximity at an interface with other materials. This work encompassed using a wide variety of data analytics, control and acquisition throughout the physical experimental labs.
				}
			}
			\begin{tabular}{ll}
...
% 			\vspace{5pt}
	...
	\cvsection{Professional Experience}
		...
		% {\textalignment
		My postdoctoral work has focused in performing X-ray measurements on organic semiconductor films at Synchrotron facilities. 
		My role comprehensively works across experimental setup and design, control automation, data acquisition and subsequent processing. 
		I have implemented and worked with experimental motion control particularly in the context of the SAXS/WAXS beamline.
		I understand nuanced experimental calibration, with detailed working knowledge of detectors and acquisition, and relevant reduction methods, having completed over 15 beamtimes.
		I have developed a number of python toolkits for interfacing with synchrotron data, published on the python package index (PyPI) and written to a modern, best-practise software engineering standard.
		This includes version-control, typing, object-orientation, unit-testing, GUIs (QtPy), publishing and documentation. 
		I utilise code assistants and AI models to drive productivity.
		...
		\cvevent{\normalsize Condensed Matter Honours/PhD - Fuhrer Lab Group}{\normalsize Monash Uni.
		...
		performing low-noise electrical measurements, streamlining data acquisition and control systems for measurements. 
		I have significant experience in GPIB control instrumentation of
		electronic equipment through python and LabView. I also demonstrated my ability to quickly learn complex systems across a wide range of nanofabrication tools (including linux based kernel environments).
		I also gained experience interfacing with linux systems and some initial python project management.

		\divider
		
		\cveventlong{\normalsize Engineering FYP}{\normalsize Monash Cold Atoms Group}{Mar 2017 -- Nov 2017}{Clayton, Australia}
		Implemented a verilog/VHDL 300 kHz - 3 MHz digital IQ demodulator circuit on an FPGA, and an analogue differential amplifier PCB circuit
		to analyse magnetometry signals acquired from Faraday measurements on cold-atoms/BECs.
		% as a final year project in collaboration with	my supervisors Lincoln Turner (Physics) and James Saunderson (Engineering).

		\divider

		\cveventlong{\normalsize Real time system design project}{\normalsize ECE5881, Monash}{Mar 2017 -- Jun 2017}{Clayton, Australia}

		Implemented an optimised PID control loop (C and VHDL) on an Altera DE2 FPGA Developement Board, using a NIOS-II uCOS-II microcontroller architecture. 
		...
		Constructed and implemented an autonomous robot to collect coloured pucks, and stack them according to a readable sequence using a mechanical claw.
		This system was implemented using a programmable system-on-chip, in particular the Cypress CY8CKIT-059 PSoC 5LP Developement Board (C programming).
