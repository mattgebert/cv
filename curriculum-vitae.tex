...
% Clear individual urldate fields globally to prevent "visited on" tags
\AtEveryBibitem{%
    \clearfield{urlday}%
    \clearfield{urlmonth}%
    \clearfield{urlyear}%
...
% For non-software entries, also clear the URL field
\AtEveryBibitem{%
...
% Custom bibliography driver for software entries with URL rendering
\DeclareBibliographyDriver{software}{%
  ...
  \newunit\newblock%
  \iffieldundef{doi}{}{%
    {, DOI: }\href{https://doi.org/\thefield{doi}}{\thefield{doi}}%
  }%
...
%            \divider
        ...
        \cvsection{About Me}
            \begin{quote}
            	Postdoctoral researcher in semiconducting materials, seeking opportunities to passionately contribute to long-term scientific research and engineering.
            \end{quote}
        \vspace{0.5em}
		{\textalignment
        % ----- ABOUT ME -----
		I am a passionate engineer and physicist, with a diverse background across x-ray \& neutron beamline science, electronic measurements and device fabrication techniques. I am a fast learner of new technology, and a highly-adapable team-member, and excellent trainer/teacher. I love creating systems/processes that are intuitive, accessible and efficient. Nothing is better than an optimised system! I am currently working as a postdoctoral fellow in synchrotron science, where I research GI-WAXS scattering at resonance conditions, by processing significantly large multi-dimensional datasets by creating and utilising modern open source toolkits, whilst having significant intereaction with electronic control systems. I have strong interpersonal qualities and communication, and well suited to working within diverse teams. I like teaching and mentoring, and am always seeking to improve upon critical feedback.
...
% 			\vspace{5pt}
		...
		\cvsubsection{\faFile*[regular] Software}
		...
		% University of Bayreuth, Germany 2025
		\cvevent{\normalsize University of Bayreuth | Swiss Light Source (SLS) | European Synchrotron Radiation Facility (ESRF)}{}{Oct 2025}{Bayreuth, Germany | Villigen, Switzerland | Grenoble, France}
		A set of talks given as part of my Engineering ECR grant to discuss the technique of "tender-resonant x-ray scattering" (TReXS) and the role it can play in understanding microstructure of organic semiconductors.

        \cvsection{Contributed Talks}

		\cveventlong{\normalsize Australiasian Community for Advanced Organic Semiconductors (AUCAOS) Symposium}{\cvreference{\faGlobe}{https://aucaos.org.au/2025/12/12/aucaos-2025-symposium-highlights/}}{}{}
		\cvevent{\normalsize Australian X-ray Analytical Association (AXAA) \& Monash X-ray Platform (MXP) Victorian X-ray Symposium}{\cvreference{\faGlobe}{https://www.axaa.org/events.html}}{Nov 2025}{Clayton, VIC, AU | Tweed Heads, NSW, AU}

        Gebert, M., Freychet, G., Thomsen, L., Gann, E., Watts, B., McNeill, C., ``Tender Resnant X-ray Scattering (T-ReXS)".
		...
		\cveventlong{\normalsize Int. Conf. for the Phys. of Semiconductors (ICPS)}{\cvreference{\faGlobe}{https://icps2022.org/program/}}{Jun 2022}{ICC, NSW, AU}
        Gebert, M., Bhattacharyya, S., Bounds, C.C., Syed, N., Daeneke, T., Fuhrer, M. S.,
        ``Suppressing remote optical phonon scattering in graphene below room temperature with touch‐printed oxide".
		...
		\cveventlong{\normalsize Int. Conf. for Undergraduate Research (ICUR)}{\cvreference{\faGlobe}{https://www.icurportal.com/past-events/icur-2017/}}{Aug 2017}{Clayton, VIC,AU}
        Gebert, M., Turner, L.
		``Using Cold Atoms as High-Precision Quantum Sensors".
        ...
        \cvsection{Awards and Scholarships}
	        \cvsubsection{Awards}
				\cvachievement{\faBullhorn}{Best ECR Speaker Talk | Victorian X-ray Symposium \faCalendar*[small] 2025
				\hspace{9em}\cvreference{\faNewspaper AXAA Newsletter link}{https://www.axaa.org/uploads/2/6/6/7/26678615/dec25.pdf\#page=2}
				}{Best ECR speaker award, for presenting work on tender-resonant x-ray scattering, at the symposium hosted by Australian X‐ray Analytical Association \& Monash X‐ray Platform, with a \$200 cash prize.}	

				\divider 

	        	\cvachievement{\faScroll}{Best ECR Poster Award | Victorian X-ray Symposium \faCalendar*[small] 2024 
				\hspace{9em}\cvreference{\faNewspaper AXAA Newsletter link}{https://www.axaa.org/uploads/2/6/6/7/26678615/dec24.pdf\#page=8}
				}{Voted best poster award for work on contrast imaging in block co-polymers, at the symposium hosted by Australian X‐ray Analytical Association \& Monash X‐ray Platform, with a \$200 cash prize.}
	        	...
	        	\cvachievement{\faBullhorn}{Outstanding Student Award | Monash Science Faculty Awards \faCalendar*[small] 2020
				\hspace{3em}\cvreference{\faNewspaper Blog link}{https://archive.fleet.org.au/blog/12772/} | \cvreference{\faCertificate Award link}{https://drive.google.com/file/d/1g3VeY3PgxkLOUvV2EcMlbWNjkn06d4-d/view?usp=drive_link}
				}{Awarded for outstanding contributions by a Graduate Research Student to the Life of the Faculty or School Community. Awarded particularly for extensive science-outreach across a range of activities and programs.
				% \hspace{9em} \cvreference{\faNewspaper Blog link}{https://archive.fleet.org.au/blog/12772/} | \cvreference{\faCertificate Award link}{https://drive.google.com/file/d/1g3VeY3PgxkLOUvV2EcMlbWNjkn06d4-d/view?usp=drive_link}
				}
	...
	% \newpage
 	    	...
 	    	\cvsubsection{Scholarships \& Funding}
 	    		...
 	    		\cvachievement{\faBusinessTime}{Early Career Researcher Grant | Faculty of Engineering \faCalendar*[small] Oct, 2025}{Selected for compeditive grant (\$5000) to travel externally and collaborate as an ECR.  I have travelled to ESRF (Grenoble, France), SLS (Switzerland) and Bayreuth University (Germany) to give talks and collaborate with beamline scienstists / researchers in x-ray scattering and spectroscopy.}

				\divider

 	    		\cvachievement{\faUserGraduate}{Education \& Training Grant | FLEET \faCalendar*[small] 2020, 2024 \hspace{16em}\cvreference{\faCertificate EdX Certificate}{https://courses.edx.org/certificates/536713ed72624d49937b0b25ff08ae19}}{Selected for compeditive grants (\$500 ea) to improve skills though a self-nominated proposal. I used these funds to undertake EdX PurdueX 69503x - Introduction to Quantum Transport (2020), and EdX EPFL - Synchrotrons \& X-ray Free Electron Lasers (2024).}
...
%	\cvsection{\faMicroscope{} Experimental Experience}
	...
	\cvsection{Experimental Experience}
		\cvevent{\normalsize Postdoctoral researcher - McNeill Group}{\normalsize Monash University\cvreference{|\faGithub kkCalc}{https://github.com/xraysoftmat/kkcalc/}\cvreference{|\faGithub pyNexafs}{https://github.com/xraysoftmat/pyNexafs}\cvreference{|\faGithub XEFI}{https://github.com/xraysoftmat/XEFI}}{Mar 2024 -- Present}{Clayton, VIC, Australia}
		{\textalignment
		As part of the McNeill research group I focus on the tender x-ray measurements of organic semiconductors. I have performed NEXAFS spectroscopy multiple times across both MEX2 and SXR beamlines, and performed X-ray scattering in/ex-situ measurements in both transmission \& grazing-incidence, not only at the SAXS/WAXS beamline in Australia and also at the tender SMI beamline at NSLS-II, NY, USA. I have significant interaction with the control systems of the beamlines we use, particularly the SAXS/WAXS beamline, and have been involved in the development of new software tools to streamline data acquisition and analysis. A particular focus of my research is the use of resonant diffraction and spectroscopy to understand the microstructure of soft matter that usually lacks strong diffraction information, which is essential to infer emergent charged transport in organic electronic devices such as photovoltaics, LEDs and transistors. To aid such efforts, I have been developing research tools using modern software engineering practices, such as python packages for Kramers Kronig transforms (kkcalc) and for beamline data handling of NEXAFS data (pyNexafs). I have responsibilities to assist our PhD students in both experimental design, acquisition, and data analysis. 
		}\vspace{1em}
		...
		\begin{multicols}{2}
			\begin{enumerate}
				...
				\item 2024-03 MEX2 Beamtime (Aus. Sync.)
				\item 2024-04 SAXS/WAXS Beamtime (Aus. Sync.)
				\item 2024-09 SMI Beamtime (NSLS-II, USA)
				\item 2024-10 MEX2 Beamtime (Aus. Sync.)
				\item 2024-12 SAXS/WAXS Beamtime (Aus. Sync.)
				\item 2025-02 MEX2 Discretionary time (Aus. Sync.)
				\item 2025-02 SMI Beamtime (NSLS-II, USA)
				\item 2025-04 SAXS/WAXS Beamtime (Aus. Sync.)
				\item 2025-06 MEX2 Beamtime (Aus. Sync.)
				\item 2025-07 SAXS/WAXS Beamtime (Aus. Sync.)
				\item 2025-08 SAXS/WAXS Beamtime (Aus. Sync.)
				\item 2026-03 MEX2 Beamtime (Aus. Sync.)
				\item 2026-03 SAXS/WAXS Beamtime (Aus. Sync.)
				\item 2026-06 (Upcoming) MEX2 Beamtime (Aus. Sync.)
				\item 2026-07 (Upcoming) SAXS/WAXS Beamtime (Aus. Sync.)
			\end{enumerate}
		\end{multicols}
		\divider
		% \newpage
		...
		% \vspace{-0.2em}
		% \newpage
		\cvevent{\normalsize Fuhrer Lab Group}{\normalsize Monash University \cvreference{ | \faNewspaper{}}{https://www.legacy.fleet.org.au/blog/a-shield-for-2d-materials-that-adds-vibrations-to-reduce-vibration-problems/}\cvreference{ | \faNewspaper{}}{https://www.techbriefs.com/component/content/article/tb/stories/blog/47435}\cvreference{| \faGithub}{https://github.com/mattgebert/pylectric-transport}\cvreference{ | \faGithub}{https://github.com/mattgebert/xrd_analysis}\cvreference{ | \faGithub}{https://github.com/mattgebert/LabViewPrograms}\cvreference{ | \faGithub}{https://github.com/mattgebert/ebl-marker-generator}\cvreference{ | \faGithub}{https://github.com/mattgebert/eagleCircuits}\cvreference{ | \faYoutube}{https://youtu.be/D6SEuttbz-A}}{Jun 2018 -- Dec 2023}{Clayton, Australia}
%		https://www.fleet.org.au/blog/a-shield-for-2d-materials-that-adds-vibrations-to-reduce-vibration-problems/
		...
		% I developed a number of rudimentary software tools for data analysis, including a Python package for electrical transport analysis, and a simplistic Python package for X-ray diffraction analysis.
...
%		\begin{paracol}{2}
		...
		\vspace{1em}\faUsers\hspace{4pt} Supervisors: Dr. Lincoln Turner and Dr. James Saunderson
...
%	\begin{paracol}{2}
		...
		\cveventlong{\normalsize AUCAOS Symposium}{\normalsize AUCAOS}{Nov 2025}{Tweed Heads, Australia}
		Australiasian Community for Advanced Organic Semiconductors (AUCAOS) annual symposium.

		\divider

		\cveventlong{\normalsize Victorian X‐ray Symposium}{\normalsize AXAA \& MXP }{Nov 2024, 2025}{Clayton, Australia}
		...
		\cveventlong{\normalsize Quantum Australia}{\normalsize Sydney Quantum Academy \cvreference{| \faNewspaper}{https://www.legacy.fleet.org.au/blog/fleet-represents-at-quantum-australia/}}{Feb 2023}{Australia}
...
%		\begin{paracol}{2}
		\cvsection{Teaching \& Education}
			\cvsubsection{\faChalkboardTeacher{} Teaching}
				\cveventlong{\normalsize Teaching Associate}{\normalsize Monash University}{Mar 2017 - Nov 2023}{Clayton, Australia} 
				\vspace{-1em}
				\begin{multicols}{2}
					\begin{itemize}
...
%			\vspace{-0.5em}
			\cvsubsection{\faUsers{} Supervision}
				...
				\cveventlong{\normalsize Masters Summer Research Project}{\normalsize Mr. Lianzheng Xie}{Dec 2024 - Feb 2025}{}
...
%			\newpage
			...
			\begin{multicols}{2}
			\begin{itemize}
				\item Journal Coverart Designs \cvreference{2021}{https://onlinelibrary.wiley.com/doi/abs/10.1002/adma.202170262},\cvreference{2023}{https://pubs.acs.org/toc/nalefd/23/1}
...
%					https://www.rrr.org.au/explore/podcasts/einstein-a-go-go
				...
				\item High school graphene / topology demos and guest classes | 2020-2023, 2026
			\end{itemize}
			\end{multicols}
...
%		\switchcolumn
		...
		\cveventlong[0.6]{\normalsize Science Meets Parliment}{\normalsize Science \& Technology Australia \cvreference{| \faNewspaper{}}{https://www.legacy.fleet.org.au/blog/18322/}}{Feb, June 2022}{Australia}
...
%		\vspace{-0.5em}
		...
		% \begin{multicols}{2}
			\begin{itemize}[itemsep=0pt]
				\item \cveventlong{\normalsize Australian X-ray Analytical Association (AXAA)}{}{2024 - Present}{}
				\item \cveventlong{\normalsize Australian Institute of Physics (AIP)}{}{2016 - Present}{}
				\item \cveventlong{\normalsize FLEET Centre of Excellence}{}{2019 - 2024}{}
			\end{itemize}
		% \end{multicols}
	...
	\begin{multicols}{2}
		\begin{itemize}
			...
			\begin{itemize}[label=\(\circ\),leftmargin=1.5em]
				\item Music team coordinator 2025 - Present
				\item Connect group leader 2024
				\item Band leader 2023 - 2025
			\end{itemize}
			\item First aider | Monash MSE Department 2025 - Present
			\item Volunteer | FLEET Outreach Programs 2019-2022
			% Force the switch
			\item Volunteer | ISCAST (Institute for the Study of Christianity in an Age of Science \& Technology) 2022, 2025 - Present
			\begin{itemize}[label=\(\circ\),leftmargin=1.5em]
				\item High-school visits 2025,26
				\item Conference assistance 2022
			\end{itemize}
