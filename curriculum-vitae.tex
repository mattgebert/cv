	...
	\cvsection{Experimental Experience}
		...
		\begin{multicols}{2}
			\begin{enumerate}
				...
				\item 2026-06 MEX2 Beamtime (Aus. Sync.)
				\item 2026-07 SAXS/WAXS Beamtime (Aus. Sync.)
			\end{enumerate}
		\end{multicols}
		\divider
		% \newpage
