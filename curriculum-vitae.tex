...
% %			\vspace{-2em}
	...
	\cvsection{Complementary expertise}
		...
		\setcolumnwidth{0.33\linewidth,0.33\linewidth,0.33\linewidth}
    	% \columnratio{0.33}
		\begin{paracol}{3}
			...
			\begin{itemize}
				...
				\item \textbf{Student supervision} experience for two Undergrad/Masters student projects. Enjoy teaching and mentoring.
			\end{itemize}
			\switchcolumn
			\cvsubsection{Awards}
			...
			{Compeditive grant (\$500). Used funds to undertake EdX Quantum Transport course.}
		\end{paracol}
