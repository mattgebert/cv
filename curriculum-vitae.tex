...
%				\medskip
				...
				\cvtags{Electronic Transport, 2D Materials, Topological Materials, Reflectometry, Cryogenics, UHV}
				\medskip
...
%            \divider
		...
		I am a passionate scientist and engineer with a diverse background in fabrication, beamline and electronic techniques. I am a fast learner of new technology, and highly-adapable team-member. I love creating meaningful, optimised algorithms \& processes. Nothing is better than an efficient system! I enjoy new challenges and perfecting processes, which is part of my drive in science, and am a hobbyist programmer. I am currently working as a postdoctoral fellow in synchrotron science, where I do a lot of programming. I have strong interpersonal qualities and communication, and well suited to working within diverse teams. I like teaching and mentoring, and am always wanting to improve upon critical feedback.
		}
...
%            \cvreference
			...
			\cvachievementnoicon{Experimental Physics Thesis: Dirac Fermions at Interfaces}{	
				...
				The ANSTO Lucas Heights facility was used to perform Neutron Reflectometry using the Platypus beamline, in addition to other tools.
...
% %			\vspace{-2em}
	...
	\cvsection{Professional Experience}
		...
		\cvevent{\normalsize Postdoctoral researcher - McNeill Group}{\normalsize Monash University\cvreference{|\faGithub}{https://github.com/mattgebert/pyNexafs}}{Mar 2024 -- Present}{Clayton, VIC, Australia}
		My recent appointment to the McNeill research group is focused in tender x-ray measurements of organic semiconductors. As part of this program I am developing research tools using modern software engineering practices. In my time thus far I have performed NEXAFS spectroscopy with medium and soft energy X-rays, and GI-WAXS.
...
%		\newpage
		...
		\textalignment{
		I conducted my research as a student in the Fuhrer lab group. This included restarting the electronic device fabrication section of the group, performing low-noise electrical measurements, and streamlining data acquisition and control systems for measurements. Fabrication techniques included molecular beam epitaxy (MBE) growths, exfoliation, mechanical sample transfer, liquid metal printing and vapor deposition methods. I have also developed a number of software tools for data analysis, including a Python package for electrical transport analysis, and a Python package for X-ray diffraction analysis.
		}
		% \begin{itemize}
...
%		\divider
		...
		\noindent\cveventlong{\normalsize Research User}{\normalsize Melbourne Centre for Nanofabrication}{Jun 2018 -- Present}{Clayton, VIC, Australia}
		\textalignment{
		...
		Equipment I worked with included the Raith EBPG5000plusES electron-beam-lithography system (Linux OS), 
		the Intelligent Micropatterning SF100 XPRESS, Wire Bonder Wedge FS Bondtec, and the Oxford PlasmaPro 100 ICP RIE system, and e-beam/thermal deposition systems.
		}
