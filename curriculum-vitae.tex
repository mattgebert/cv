	...
	\cvsection{Experimental Experience}
		...
		\begin{multicols}{2}
			\begin{enumerate}
				...
				\item 2025-07 SAXS/WAXS Beamtime (Aus. Synchrotron)
				\item 2025-08 SAXS/WAXS Beamtime (Aus. Synchrotron)
				\item 2026-03 MEX2 Beamtime (Aus. Synchrotron)
				\item 2026-03 (Upcoming) SAXS/WAXS Beamtime (Aus. Synchrotron)
				\item 2026-06 (Upcoming) MEX2 Beamtime (Aus. Synchrotron)
			\end{enumerate}
		\end{multicols}
		\divider
		% \newpage
...
%	\begin{paracol}{2}
		...
		\cveventlong{\normalsize AUCAOS Symposium}{\normalsize AXAA \& MXP }{Nov 2025}{Tweed Heads, Australia}
		Australiasian Community for Advanced Organic Semiconductors annual symposium.
