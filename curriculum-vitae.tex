...
%            \divider
        ...
        \cvsection{About Me}
            \begin{quote}
            	Software savvy condensed matter physicist and electrical \& computer system engineer, seeking opportunities to passionately contribute to long-term scientific research and education.
            \end{quote}
        \vspace{0.5em}
		{\textalignment
        % ----- ABOUT ME -----
...
% 			\vspace{5pt}
	...
	\cvsection{Professional Experience}
		...
		% {\textalignment
		My postdoctoral work is focused in performing X-ray measurements on organic semiconductor films at Synchrotrons. 
		I have developed a number of python toolkits for interfacing with data, published on the python package index (PyPI) and written to a modern software engineering standard that demonstrated best-practise, particularly important for research contexts where software quality is often very poorly maintained. 
		This includes version-control, typing, object-orientation, unit-testing, GUIs (QtPy), publishing and documentation styles. 
		I utilise code assistants and AI models to drive productivity.
		This role comprehensively works across experimental setup and design, control automation, data acquisition and subsequent processing. I understand nuanced experimental calibration, with detailed working knowledge of detectors and acquisition, and relevant reduction methods, having completed over 15 beamtimes.
