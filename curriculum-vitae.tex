...
\begin{document}
	...
	\IfFileExists{personal-info.tex}{
    	\subfile{./personal-info.tex}
	}{
		\subfile{./personal-info-example.tex}
	}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{TECH STACK}
            ...
            \begin{sloppypar*}
                ...
                \cvtags{Full-stack, Data Analysis, Data Visualisation, Real-time Systems, Control, Algorithms, Linux\faLinux\faUbuntu, Servers}
                \medskip
                
                \cvtags{Mathematica, AutoCAD, Blender, KLayout}
            \end{sloppypar*}
        % ----- TECH STACK -----
...
%            \divider
        ...
        \cvsection{References}
            \cvref{Assist. Prof.\\ Semonti Bhattacharrya}{Leiden University}{
            	bhattacharyya@physics .leidenuniv.nl}{+31 71 527 5913}{semonti-physics}{LinkedIn}
            \divider

            \cvref{Dr. David Cortie}{NR Instrument Scientist, Australian Nuclear Sci. \& Technology Org. (ANSTO)}{dcr@ansto.gov.au}{+61 2 9717 3083}{david-cortie-6b00651b1}{LinkedIn}
            \divider
            
            \cvref{Prof. Michael Fuhrer}{Director FLEET, Monash}{michael.fuhrer@monash.edu}{+61 3 9905 1353}{michael-fuhrer-3483707b/}{LinkedIn}
        % ----- REFERENCES -----
...
%        \cvlang{}
        ...
        \vspace{0.5em}
        % ----- ABOUT ME -----
        I am a passionate scientist and engineer who loves exploring new technology and creating meaningful, optimised algorithms \& processes. Nothing is better than an efficient system! I really enjoy figuring new things out, which is part of my drive in science, and am a hobbyist programmer. I have strong interpersonal qualities and communication, well suited to working within diverse teams. I like teaching and mentoring, and am always wanting to improve upon critical feedback.
%        I love to dabble in code, teach and mentor, and prefer to have clear targets to work towards. My hobbies include music, where I have studied piano to AMEB Grade 8 and do a little electronic production, SciFy video games, Formula1 and Cycling, and home DIY. 
        ...
        \vspace{-1em}
        \cvsection{Education}
            \cvevent{Doctor of Philosophy Candidate, Physics}{Monash University | \cvreference{FLEET}{https://www.fleet.org.au}}{Sep 2019 -- Present}{Clayton, Australia}
%            \cvreference
...
%	        \endgroup
			...
			\end{multicols}
			\vspace{-1em}
        	Electrical \& Computer Systems Eng., Physics, Applied Mathematics \& Comp. Sci.\newline Specialised into FPGA, real-time systems and analogue electronics.\\
