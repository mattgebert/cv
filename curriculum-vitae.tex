...
% 			\vspace{5pt}
	...
	% \newpage
 	    	...
 	    	\cvsubsection{Scholarships \& Funding}
 	    		...
 	    		\cvachievement{\faBusinessTime}{Early Career Researcher Grant | Faculty of Engineering \faCalendar*[small] 2025}{Selected for compeditive grant (\$5000) to travel externally and collaborate as an ECR.  I have scheduled travel to ESRF (Grenoble, France), SLS (Switzerland) and Bayreuth University (Germany) to give talks and collaborate with beamline scienstists / researchers in x-ray scattering and spectroscopy, in October 2025.}
...
%	\cvsection{\faMicroscope{} Experimental Experience}
	\cvsection{Experimental Experience}
		\cvevent{\normalsize Postdoctoral researcher - McNeill Group}{\normalsize Monash University\cvreference{|\faGithub kkCalc}{https://github.com/xraysoftmat/kkcalc/}\cvreference{|\faGithub pyNexafs}{https://github.com/xraysoftmat/pyNexafs}}{Mar 2024 -- Present}{Clayton, VIC, Australia}
		{\textalignment
...
%	\begin{paracol}{2}
		...
		\cveventlong{\normalsize Victorian X‐ray Symposium}{\normalsize AXAA \& MXP }{Nov 2024}{Clayton, Australia}
